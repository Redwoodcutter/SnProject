           ...
           <div class="col-lg-6">
            ...
            <form method="post" action="<?=base_url()?>Settings/picture/<?=$veri[0]->id?>">
                ...
                <button type="submit" class="btn btn-primary">Resim Ekle</button>
                 ...
                 <form method="post" action="<?=base_url()?>Settings/guncelle/<?=$veri[0]->id?>">  
                    ...
                    <div class="form-group" >
                        ...
                        <input type="text" hidden class="form-control" id="Id" name="Id" value="<?=$veri[0]->id?>" >
                    </div>
                    <div class="form-group">
                        <label id="kategori">userId</label>
                        <input type="text"  hidden class="form-control" id="userId" name="userId" value="<?=$veri[0]->user_id?>">
                    </div>
                ...
                <h4>Sosyal Medya Hesapları</h4>
                    ...
                    <div class="form-group">
                        <label id="resim">Web Page</label>
                        <input type="text" class="form-control" id="resim" name="pinterest"  value="<?=$veri[0]->web?>" >
                    </div> 
